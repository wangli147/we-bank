	    					...
	    					<div className="wl_align">
	    						<div className="wl_device">
	    							<div className="wl_container">
	    								<Carousel autoplay>
										    <div className="wl_two"><img src={pic1} /></div>
										    <div className="wl_two"><img src={pic2} /></div>
										 </Carousel>
										 <Carousel autoplay>
										    <div className="wl_four"><img src={pic3} /></div>
										    <div className="wl_four"><img src={pic4} /></div>
										    <div className="wl_four"><img src={pic5} /></div>
										    <div className="wl_four"><img src={pic6} /></div>
										 </Carousel>
	    							</div>
	    						</div>
	    					</div>
